...
// PUT update client
const putClient = async ( id: number, updatedClient: Partial<ClientCreation>): Promise<Client | null> => {
...
export { getClients, getClientById, postClient, putClient, deleteClient };
